...
#        car2 = np.loadtxt("./meas/Car/v1.umt")
        ...
        car1 = pandas.read_csv("./meas/Car/v0.umt", header = None); car1 = ExtractCar(car1)
        car2 = pandas.read_csv("./meas/Car/v1.umt", header = None); car2 = ExtractCar(car2)
        ...
        plt.figure()
        plt.plot(t.T, diff[0].T, label = 'x')
        plt.plot(t.T, diff[1].T, label = 'y')
        plt.plot(t.T, diff[2].T, label = 'z')
        ...
        plt.figure()
        plt.plot(t.T, est_clk.T, label = 'Receiver Clock offset')
        plt.legend(loc='lower right')
        plt.xlabel('Time(sec)')
        plt.ylabel('m')    
