...
# =============================================================================
    ...
    CEDOP_list = []
    CNDOP_list = []
    initial_clk = [1200000, 150, -2000000, 150]      ################################################ initialization ########3
# =============================================================================
    # main loop
    ...
    # if t=0, set initial value (from obs file) of position
        if t == 0:
            pos_s = []
            for i in range(0, num_car):
                pos_s.append(initial_position(XYZ_Station[i], initial_clk[2*i], initial_clk[2*i+1]))          ############ initialization ######### 
            pos = mat(pos_s)
...
# =============================================================================
        ...
        for i in range(num_car + 5):
            threshold.append(20)           #####################################################elevation angle
        for i in range(0, num_car):
...
# =============================================================================
                        PR.append(obs[i][indx[i*2][j]][3] + satorbit[3] - T - I)
#                        else:
#                            PR.append(obs[i][indx[i*2][j]][3] + satorbit[3])
                        azim.append(azimuth)
                        elev.append(elevation)
#                        sigma = 293 * 0.1 * math.sqrt(0.5) * pow(10, -(obs[i][indx[i*2][j]][6]-2*abs(obs[i][indx[i*2][j]][6]-53.99))/20)
...
# =============================================================================
    ...
    # =============================================================================
            ...
            CGDOP = np.nan
            CWGDOP = np.nan
            CEDOP_list.append(np.nan)
            CNDOP_list.append(np.nan)
...
#    gps1, _, _, _ = ReadRinexSprientObs(crf + '/Data/obs/0923circle.obs')
    # Read car 
#    car0 = pandas.read_csv(crf + '/Data/umt/v0.umt', header = None); car0 = ExtractCar(car0,1)
#    car1 = pandas.read_csv(crf + '/Data/umt/v1.umt', header = None); car1 = ExtractCar(car1,1)
#    car2 = pandas.read_csv(crf + '/Data/umt/v2.umt', header = None); car2 = ExtractCar(car2,1)
#    car3 = pandas.read_csv(crf + '/Data/umt/v3.umt', header = None); car3 = ExtractCar(car3,1)
#    car4 = pandas.read_csv(crf + '/Data/umt/v4.umt', header = None); car4 = ExtractCar(car4,1)
#    car5 = pandas.read_csv(crf + '/Data/umt/v5.umt', header = None); car5 = ExtractCar(car5,1)
#    car6 = pandas.read_csv(crf + '/Data/umt/v6.umt', header = None); car6 = ExtractCar(car6,1)
#    car7 = pandas.read_csv(crf + '/Data/umt/v7.umt', header = None); car7 = ExtractCar(car7,1)
#    car8 = pandas.read_csv(crf + '/Data/umt/v8.umt', header = None); car8 = ExtractCar(car8,1)
#    car9 = pandas.read_csv(crf + '/Data/umt/v9.umt', header = None); car9 = ExtractCar(car9,1)
#    car10 = pandas.read_csv(crf + '/Data/umt/v10.umt', header = None); car10 = ExtractCar(car10,1)
#    car11 = pandas.read_csv(crf + '/Data/umt/v11.umt', header = None); car11 = ExtractCar(car11,1)
#    car12 = pandas.read_csv(crf + '/Data/umt/v12.umt', header = None); car12 = ExtractCar(car12,1)
#    car13 = pandas.read_csv(crf + '/Data/umt/v13.umt', header = None); car13 = ExtractCar(car13,1)
#    car14 = pandas.read_csv(crf + '/Data/umt/v14.umt', header = None); car14 = ExtractCar(car14,1)
...
#    car1 = pandas.read_csv(crf + '/Data/umt/0923circle.umt', header = None); car1 = ExtractCar(car1)
    ##    # copos
#    r,CGDOP,CWGDOP,CEDOP,CNDOP= Kalman_Collaborative(gps0,ephemeris,car0,
...
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps5,ephemeris,car5,gps6,ephemeris,car6)
#=============================================================================
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1,gps2,ephemeris,car2,gps3,ephemeris,car3)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1,gps2,ephemeris,car2,gps3,ephemeris,car3,
#                                                                          gps4,ephemeris,car4,gps5,ephemeris,car5,gps6,ephemeris,car6)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1,gps2,ephemeris,car2,gps3,ephemeris,car3,
#                                                                          gps4,ephemeris,car4,gps5,ephemeris,car5,gps6,ephemeris,car6,
#                                                                          gps7,ephemeris,car7,gps8,ephemeris,car8,gps9,ephemeris,car9)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1,gps2,ephemeris,car2,gps3,ephemeris,car3,
#                                                                          gps4,ephemeris,car4,gps5,ephemeris,car5,gps6,ephemeris,car6,
#                                                                          gps7,ephemeris,car7,gps8,ephemeris,car8,gps9,ephemeris,car9,
#                                                                    gps10,ephemeris,car10,gps11,ephemeris,car11,gps12,ephemeris,car12)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps1,ephemeris,car1,gps2,ephemeris,car2,gps3,ephemeris,car3,
#                                                                          gps4,ephemeris,car4,gps5,ephemeris,car5,gps6,ephemeris,car6,
#                                                                          gps7,ephemeris,car7,gps8,ephemeris,car8,gps9,ephemeris,car9,
#                                                                    gps10,ephemeris,car10,gps11,ephemeris,car11,gps12,ephemeris,car12,
#                                                                    gps13,ephemeris,car13,gps14,ephemeris,car14)
#=============================================================================
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps2,ephemeris,car2,gps3,ephemeris,car3)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps13,ephemeris,car13,gps14,ephemeris,car14)
#    r,CGDOP,CWGDOP,CEDOP,CNDOP = Kalman_Collaborative(gps0,ephemeris,car0,gps2,ephemeris,car2,gps3,ephemeris,car3,gps13,ephemeris,car13,gps14,ephemeris,car14)
#=============================================================================
#    gps1, _, _, _ = ReadRinexRealObs(crf + '/Data/obs/190523_1.obs')
#    ephemeris1, _, _, _, _, = ReadRinexRealNav(crf+'/Data/Nav/190523_1.nav')
#    car1 = pandas.read_csv(crf + '/Data/umt/190523_1.umt', header = None); car1 = ExtractCar(car1,2)
#    
#    gps2, _, _, _ = ReadRinexRealObs(crf + '/Data/obs/190523_2.obs')
#    ephemeris2, _, _, _, _, = ReadRinexRealNav(crf+'/Data/Nav/190523_1.nav')
#    car2 = pandas.read_csv(crf + '/Data/umt/190523_2.umt', header = None); car2 = ExtractCar(car2,2)
...
#    est_car_z = mat(list(zip(* r))[3])
    ...
    fig.suptitle('EKF CP ENU deviation')
    axs[0].plot(diff_prime[0], label = 'xEast')
    axs[1].plot(diff_prime[1], label = 'yNorth')
    axs[2].plot(diff_prime[2], label = 'zUp')
